...
cp /home/travis/build/grails-profiles-tests/web-jboss7/build/grails-wrapper/wrapper/build/libs/grails4-wrapper-2.0.1.BUILD-SNAPSHOT.jar $HOME/.grails/wrapper/grails4-wrapper.jar
