...
cp /home/travis/build/grails-profiles-tests/web-jboss7/build/grails-wrapper/wrapper/build/libs/grails-wrapper-1.0.1.BUILD-SNAPSHOT.jar $HOME/.grails/wrapper/grails-wrapper.jar
