...
mv web-jboss7 multi/web-jboss7

mv multi/web-jboss7/gradle multi/gradle

mv multi/web-jboss7/gradlew multi/gradlew

mv multi/web-jboss7/gradlew.bat multi/gradlew.bat
...
echo "include 'web-jboss7', 'functional-tests'" >> settings.gradle
